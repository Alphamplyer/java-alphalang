...
public class Scanner {
    ...
    private void scanToken() {
        ...
        switch (c) {
            ...
            case '{': addToken(LEFT_CURLY_BRACE); break;
            case '}': addToken(RIGHT_CURLY_BRACE); break;
            ...
            case '/':
                if (match('/')) {
                    // Line that begin with '//' are comment until the end of the line
                    while (peek() != '\n' && !isAtEnd())
                        advance();
                } else {
                    addToken(SLASH);
            ...
            default:
                if (isDigit(c)) {
                    ...
                    Alpha.error(line, "Unexpected character.");
                }
                break;
        }
    }
